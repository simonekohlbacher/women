...
<template>
  ...
  <DetailHeader :icon="['fas', 'hand-holding-dollar']" title="Pink Tax" />


 <div class="detial-content p-6 md:p-12">
    <div class="flex items-center my-4">
      <div class="flex-1 border-t border-white"></div>
      <p class="mx-4 text-center text-s w-[50vw]">
        Höhere Preise für Produkte/Dienstleistungen für Frauen
      </p>
      <div class="flex-1 border-t border-white"></div>
    </div>
